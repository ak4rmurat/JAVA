...
import day22_stringBuilder_accessModifier_encapsulation.C05_RaporClass;
...
public class C01_AccessModifier_ChildClass extends C03_AccessModifier {
    ...
    public static void main(String[] args) {
      ...
      //// private class uyeleri icinde bulunduklari class disinda hicbir yerden KULLANILAMA
